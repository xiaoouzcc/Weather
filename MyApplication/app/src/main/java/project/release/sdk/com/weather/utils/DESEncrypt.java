...
public class DESEncrypt {
    ...
    // 默认密钥
    private static String strDefaultKey = "fumaoxiaolong";
    ...
    public static String encryptCatchException(String strIn) {
        DESEncrypt ins = getInstance();
        String result = null;
        try {
            result = ins.encrypt(strIn);
        } catch (Exception e) {
        }
        return result;
    }
